-- Seed data for Property Task Manager
-- Run this after creating the schema

-- Insert default users
INSERT INTO users (id, name, email, approval_level, role, permissions, is_archived, created_at, updated_at) VALUES
('1', 'Admin User', 'admin@company.com', 3, 'admin', ARRAY['create_projects', 'edit_projects', 'delete_projects', 'approve_projects', 'manage_users', 'manage_settings'], false, '2024-01-01', '2024-01-01'),
('2', 'Manager User', 'manager@company.com', 2, 'manager', ARRAY['create_projects', 'edit_projects', 'approve_projects', 'create_tasks', 'edit_tasks'], false, '2024-01-01', '2024-01-01'),
('3', 'Regular User', 'user@company.com', 1, 'user', ARRAY['create_tasks', 'edit_tasks'], false, '2024-01-01', '2024-01-01');

-- Insert properties
INSERT INTO properties (id, name, address, description, created_at, updated_at) VALUES
('1', 'Corporate Headquarters', '123 Main St, Downtown', 'Commercial office building with 10 floors', '2024-01-01', '2024-01-01'),
('2', 'Regional Distribution Center', '456 Oak Ave, Suburbs', '50-unit residential apartment complex', '2024-01-15', '2024-01-15');
...
('Level 1 Approvers', 1, ARRAY['3'], 'Basic level approval group', NOW(), NOW()),
('Level 2 Approvers', 2, ARRAY['2'], 'Management level approval group', NOW(), NOW()),
('Level 3 Approvers', 3, ARRAY['1'], 'Executive level approval group', NOW(), NOW());
...
('1', 'HVAC System Upgrade', 'Complete HVAC system replacement and upgrade', '1', 86000, 'Security Systems', '2024-10-01', '2024-12-15', 'in-progress', 'high', 'single', 1, '1', '1', '2024-09-29', '2024-09-29'),
('2', 'Parking Lot Resurfacing', 'Complete parking lot resurfacing and line painting', '2', 33000, 'Renovation & Upgrades', '2024-10-15', '2024-11-30', 'planning', 'low', 'single', 1, '1', '1', '2024-09-29', '2024-09-29');

-- Insert funding details
INSERT INTO funding_details (id, type, amount, date, project_id, payment_status, paid_date, paid_by) VALUES
('1', 'deposit', 15000, '2024-10-01', '1', 'unpaid', NULL, NULL),
('2', 'final', 28000, '2024-10-24', '2', 'unpaid', NULL, NULL),
('3', 'deposit', 5000, '2024-10-03', '2', 'paid', '2024-10-02', '1');
...
('1', 'Install new HVAC units', 'Install and configure new HVAC units on floors 1-5', '2024-10-01', '2024-10-15', '2', '1', '1', 'in-progress', 'high', '2024-09-29', '2024-09-29'),
('2', 'Test HVAC systems', 'Test and calibrate all HVAC systems', '2024-10-16', '2024-10-20', '3', '1', '1', 'pending', 'medium', '2024-09-29', '2024-09-29'),
('3', 'Prepare parking lot surface', 'Clean and prepare parking lot for resurfacing', '2024-10-15', '2024-10-18', '2', '2', '2', 'pending', 'low', '2024-09-29', '2024-09-29'),
('4', 'Apply new surface coating', 'Apply new asphalt surface coating', '2024-10-19', '2024-10-25', '3', '2', '2', 'pending', 'low', '2024-09-29', '2024-09-29'),
('5', 'Paint parking lines', 'Paint new parking lines and markings', '2024-10-26', '2024-10-30', '2', '2', '2', 'pending', 'low', '2024-09-29', '2024-09-29');
